...
function OpenBox({ move, sphereRadius, ...props }) {
		...
		shapes: [
			{
				...
				args: [boxLength, boxWidth, 1],
			},
			{
				type: 'Box',
				position: [boxLength / 2, boxEdgeHeight / 2 - sphereRadius, 0],
				rotation: [0, Math.PI / 2, 0],
				args: [boxWidth, boxEdgeHeight, boxThickness + sphereRadius * 2],
			},
			{
				type: 'Box',
				position: [-boxLength / 2, , boxEdgeHeight / 2 - sphereRadius, 0],
			...
			{
				type: 'Box',
				position: [0, boxEdgeHeight / 2, boxWidth / 2 - sphereRadius],
				rotation: [0, 0, 0],
				args: [boxLength, boxEdgeHeight, boxThickness + sphereRadius * 2],
			},
			{
				type: 'Box',
				position: [0, boxEdgeHeight / 2, -boxWidth / 2 - sphereRadius],
	...
	return (
		<group ref={ref}>
			...
			<mesh
				position={[boxLength / 2, boxEdgeHeight / 2 - 0.1, 0]}
				rotation={[0, Math.PI / 2, 0]}
			>
			...
			<mesh
				position={[0, boxEdgeHeight / 2 - 0.1, boxWidth / 2]}
				rotation={[0, 0, 0]}
			>
